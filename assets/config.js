...
const types = ['', 'Pré-analytique', 'Analytique', 'Post-analytique', 'Autre'];
...
let descriptifsPre = [
  ...
  'Absence information prescripteur',
...
let descriptifAnalytique = [
  ...
  'Analyse oubliée ou spécimen égaré',
  'Mauvaise analyse réalisée',
];

let descriptifPost = ['', 'Rapport émis au mauvais destinataire'];
